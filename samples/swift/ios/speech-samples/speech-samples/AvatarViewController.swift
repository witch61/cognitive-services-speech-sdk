...
class AvatarViewController: UIViewController {
    ...
    private let speechSubscriptionKey = "9zP5NeEXobQlBFoBbPTdz44D4KpGEmkhhVp0OT9pEOfOxHnWig53JQQJ99BDAC3pKaRXJ3w3AAAYACOGjlvQ"
    // Replace below with your own service region (e.g., "westus2").
    private let serviceRegion = "eastasia"
...
//        rtcRender.backgroundColor = UIColor.yellow
    ...
    private func initializePeerConnectionFactory() {
        ...
        let audioSource = AvatarViewController.peerConnectionFactory.audioSource(with: audioConstraints)
        self.audioTrack = AvatarViewController.peerConnectionFactory.audioTrack(with: audioSource, trackId: AUDIO_TRACK_ID)

        // Create video track
        let videoSource = AvatarViewController.peerConnectionFactory.videoSource()
        self.videoTrack = AvatarViewController.peerConnectionFactory.videoTrack(with: videoSource, trackId: VIDEO_TRACK_ID)
    }
    ...
    private func setupWebRTC() {
        ...
        // PeerConnection
        peerConnection = AvatarViewController.peerConnectionFactory.peerConnection(with: rtcConfig, constraints: constraints1, delegate: self)
...
extension AvatarViewController: RTCPeerConnectionDelegate {
